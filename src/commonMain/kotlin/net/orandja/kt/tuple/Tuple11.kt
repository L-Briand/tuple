...
@Serializable(Tuple11.Serializer::class)
data class Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(
    ...
    class Serializer<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(
    ...
    ) : AbstractTupleSerializer<Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>(
        ...
        override fun CompositeDecoder.deserializeTuple(): Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> = tuple(
        ...
        override fun CompositeEncoder.serializeTuple(value: Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>) {
